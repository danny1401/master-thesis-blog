    ...
    >
      ...
      <div className="flex flex-col gap-y-3 max-w-lg md:max-w-6xl text-foreground">
        ...
        <div className="md:leading-tight font-bold mt-3">
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl mb-0 sm:mb-1 md:mb-3 whitespace-nowrap">
        ...
        <div className="flex flex-col text-sm sm:text-base md:text-lg mt-4 sm:mt-4 space-y-2 sm:space-y-0">
